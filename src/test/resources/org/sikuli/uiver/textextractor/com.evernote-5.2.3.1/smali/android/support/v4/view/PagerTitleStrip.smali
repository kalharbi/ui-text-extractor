...
.field private static final q:Landroid/support/v4/view/ab;
...
.field private final l:Landroid/support/v4/view/aa;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Landroid/support/v4/view/ab;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, v0}, Landroid/support/v4/view/aa;-><init>(Landroid/support/v4/view/PagerTitleStrip;B)V

    iput-object v1, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/aa;
...
.method private static a(Landroid/widget/TextView;)V
    ...
    .prologue
    .line 108
    sget-object v0, Landroid/support/v4/view/PagerTitleStrip;->q:Landroid/support/v4/view/ab;

    invoke-interface {v0, p0}, Landroid/support/v4/view/ab;->a(Landroid/widget/TextView;)V
...
.method a(IFZ)V
    ...
    invoke-virtual {v2}, Landroid/support/v4/view/ViewPager;->a()Landroid/support/v4/view/x;
...
.method final a(ILandroid/support/v4/view/x;)V
    .locals 6
    .parameter
    .parameter
    ...
    invoke-virtual {p2}, Landroid/support/v4/view/x;->getCount()I
    ...
    invoke-virtual {p2, v2}, Landroid/support/v4/view/x;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, p1}, Landroid/support/v4/view/x;->getPageTitle(I)Ljava/lang/CharSequence;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/x;->getPageTitle(I)Ljava/lang/CharSequence;
...
.method final a(Landroid/support/v4/view/x;Landroid/support/v4/view/x;)V
    .locals 1
    .parameter
    .parameter
    ...
    .line 317
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/aa;

    invoke-virtual {p1, v0}, Landroid/support/v4/view/x;->unregisterDataSetObserver(Landroid/database/DataSetObserver;)V
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/view/x;->registerDataSetObserver(Landroid/database/DataSetObserver;)V
...
.method protected onAttachedToWindow()V
    ...
    .line 251
    invoke-virtual {v0}, Landroid/support/v4/view/ViewPager;->a()Landroid/support/v4/view/x;

    move-result-object v1

    .line 253
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/aa;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bj;)Landroid/support/v4/view/bj;

    .line 254
    iget-object v2, p0, Landroid/support/v4/view/PagerTitleStrip;->l:Landroid/support/v4/view/aa;

    invoke-virtual {v0, v2}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bi;)V
...
.method protected onDetachedFromWindow()V
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bj;)Landroid/support/v4/view/bj;

    .line 265
    iget-object v0, p0, Landroid/support/v4/view/PagerTitleStrip;->a:Landroid/support/v4/view/ViewPager;

    invoke-virtual {v0, v1}, Landroid/support/v4/view/ViewPager;->a(Landroid/support/v4/view/bi;)V
