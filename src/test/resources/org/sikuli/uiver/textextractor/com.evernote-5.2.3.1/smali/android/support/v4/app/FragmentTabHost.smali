...
.field private g:Landroid/support/v4/app/y;
...
.method private a(Ljava/lang/String;Landroid/support/v4/app/z;)Landroid/support/v4/app/z;
    ...
    .line 321
    invoke-static {v0}, Landroid/support/v4/app/y;->b(Landroid/support/v4/app/y;)Ljava/lang/String;
    ...
    .line 328
    :cond_1
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/y;
    ...
    .line 330
    iget-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/m;
    ...
    invoke-static {v0}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/y;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/z;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/z;
    ...
    .line 338
    invoke-static {v1}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/y;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/y;->c(Landroid/support/v4/app/y;)Ljava/lang/Class;
    ...
    invoke-static {v1}, Landroid/support/v4/app/y;->d(Landroid/support/v4/app/y;)Landroid/os/Bundle;
    ...
    invoke-static {v1, v0}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/y;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-static {v1}, Landroid/support/v4/app/y;->b(Landroid/support/v4/app/y;)Ljava/lang/String;
    ...
    :cond_4
    :goto_2
    iput-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/y;
    ...
    invoke-virtual {p2, v0}, Landroid/support/v4/app/z;->e(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/z;
...
.method protected onAttachedToWindow()V
    ...
    .line 255
    iget-object v4, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/m;
    ...
    invoke-static {v0, v4}, Landroid/support/v4/app/y;->a(Landroid/support/v4/app/y;Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/Fragment;
    ...
    invoke-virtual {v4}, Landroid/support/v4/app/Fragment;->q()Z
    ...
    .line 261
    iput-object v0, p0, Landroid/support/v4/app/FragmentTabHost;->g:Landroid/support/v4/app/y;
    ...
    .line 266
    iget-object v1, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/m;
    ...
    invoke-virtual {v1, v0}, Landroid/support/v4/app/z;->d(Landroid/support/v4/app/Fragment;)Landroid/support/v4/app/z;
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/m;)V
    .locals 0
    .parameter
    .parameter
    ...
    .line 188
    iput-object p2, p0, Landroid/support/v4/app/FragmentTabHost;->d:Landroid/support/v4/app/m;
...
.method public setup(Landroid/content/Context;Landroid/support/v4/app/m;I)V
    .locals 2
    .parameter
    .parameter
    .parameter
