...
.method public final a(Landroid/content/BroadcastReceiver;)V
    ...
    .line 164
    iget-object v8, p0, Landroid/support/v4/a/c;->b:Ljava/util/HashMap;

    monitor-enter v8

    .line 165
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/a/c;->b:Ljava/util/HashMap;
    ...
    .line 173
    iget-object v2, p0, Landroid/support/v4/a/c;->c:Ljava/util/HashMap;
    ...
    iget-object v3, v3, Landroid/support/v4/a/f;->b:Landroid/content/BroadcastReceiver;
...
.method public final a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .prologue
    .line 134
    iget-object v2, p0, Landroid/support/v4/a/c;->b:Ljava/util/HashMap;
    ...
    invoke-direct {v3, p2, p1}, Landroid/support/v4/a/f;-><init>(Landroid/content/IntentFilter;Landroid/content/BroadcastReceiver;)V
    ...
    .line 144
    iget-object v0, p0, Landroid/support/v4/a/c;->c:Ljava/util/HashMap;
    ...
    .line 147
    iget-object v5, p0, Landroid/support/v4/a/c;->c:Ljava/util/HashMap;
...
.method public final a(Landroid/content/Intent;)Z
    ...
    iget-object v13, v0, Landroid/support/v4/a/c;->b:Ljava/util/HashMap;
    ...
    iget-object v1, v0, Landroid/support/v4/a/c;->a:Landroid/content/Context;
    ...
    iget-object v1, v0, Landroid/support/v4/a/c;->c:Ljava/util/HashMap;
    ...
    iget-object v14, v9, Landroid/support/v4/a/f;->a:Landroid/content/IntentFilter;
    ...
    .line 224
    :cond_2
    iget-boolean v1, v9, Landroid/support/v4/a/f;->c:Z
    ...
    .line 231
    :cond_4
    iget-object v1, v9, Landroid/support/v4/a/f;->a:Landroid/content/IntentFilter;
    ...
    iput-boolean v7, v9, Landroid/support/v4/a/f;->c:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    iput-boolean v3, v1, Landroid/support/v4/a/f;->c:Z
    ...
    iget-object v1, v0, Landroid/support/v4/a/c;->d:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/v4/a/e;

    move-object/from16 v0, p1

    invoke-direct {v2, v0, v10}, Landroid/support/v4/a/e;-><init>(Landroid/content/Intent;Ljava/util/ArrayList;)V
    ...
    iget-object v1, v0, Landroid/support/v4/a/c;->e:Landroid/os/Handler;
