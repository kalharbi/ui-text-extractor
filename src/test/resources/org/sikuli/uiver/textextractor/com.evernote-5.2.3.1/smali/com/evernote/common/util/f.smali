.class public final Lcom/evernote/common/util/f;
.super Lcom/evernote/common/util/c;
...
.method public constructor <init>()V
    ...
    .prologue
    .line 11
    invoke-direct {p0}, Lcom/evernote/common/util/c;-><init>()V
    ...
    :goto_0
    iput-boolean v0, p0, Lcom/evernote/common/util/f;->a:Z
...
# virtual methods
.method public final varargs a(Landroid/content/Context;Ljava/lang/CharSequence;Ljava/lang/CharSequence;Lcom/evernote/common/util/n;Landroid/content/Intent;I[Lcom/evernote/common/util/o;)Landroid/app/Notification;
    .locals 8
    .parameter
    .parameter
    .parameter
    ...
    .line 28
    sget-object v2, Lcom/evernote/common/util/g;->a:[I

    invoke-virtual {p4}, Lcom/evernote/common/util/n;->ordinal()I
    ...
    .line 56
    iget-object v0, v1, Lcom/evernote/common/util/o;->j:Landroid/graphics/Bitmap;
    ...
    .line 57
    :cond_2
    iget v0, v1, Lcom/evernote/common/util/o;->k:I
    ...
    .line 58
    :cond_3
    iget-object v0, v1, Lcom/evernote/common/util/o;->l:Ljava/lang/String;
    ...
    .line 59
    :cond_4
    iget-object v0, v1, Lcom/evernote/common/util/o;->m:Landroid/app/PendingIntent;
    ...
    .line 62
    :cond_5
    iget-boolean v0, p0, Lcom/evernote/common/util/f;->a:Z
    ...
    .line 64
    iget-object v0, v1, Lcom/evernote/common/util/o;->n:Ljava/lang/String;
    ...
    .line 67
    :cond_6
    iget v0, v1, Lcom/evernote/common/util/o;->h:I

    invoke-virtual {v2, v0}, Landroid/app/Notification$Builder;->setPriority(I)Landroid/app/Notification$Builder;

    .line 70
    iget-object v0, v1, Lcom/evernote/common/util/o;->i:Ljava/util/List;
    ...
    check-cast v0, Lcom/evernote/common/util/i;

    .line 71
    iget v4, v0, Lcom/evernote/common/util/i;->a:I

    iget-object v5, v0, Lcom/evernote/common/util/i;->b:Ljava/lang/CharSequence;

    iget-object v0, v0, Lcom/evernote/common/util/i;->c:Landroid/app/PendingIntent;
    ...
    .line 78
    check-cast v0, Lcom/evernote/common/util/m;

    iget-object v0, v0, Lcom/evernote/common/util/m;->a:Ljava/lang/CharSequence;
    ...
    iget-object v0, v0, Lcom/evernote/common/util/m;->b:Ljava/util/List;
    ...
    iget-object v0, v1, Lcom/evernote/common/util/m;->b:Ljava/util/List;
    ...
    .line 87
    :cond_b
    instance-of v0, v1, Lcom/evernote/common/util/j;
    ...
    iget-object v0, v0, Lcom/evernote/common/util/j;->a:Landroid/graphics/Bitmap;
    ...
    .line 91
    iget v1, v1, Lcom/evernote/common/util/o;->k:I
    ...
    check-cast v1, Lcom/evernote/common/util/k;

    iget-object v1, v1, Lcom/evernote/common/util/k;->a:Ljava/lang/CharSequence;
    ...
    iget-object v1, v1, Lcom/evernote/common/util/l;->a:Landroid/widget/RemoteViews;
